...
@Aspect
@Component
public class LinkServiceAspect {
    @Before(value = "execution(* com.example.demo.Teacher.TeacherService.*(..)) && args(s)")
    ...
    @After(value = "execution(* com.example.demo.Teacher.TeacherService.*(..)) && args(s)")
